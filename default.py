...
def ROOT():
  addDir('AMC', 'https://digionline.hu/player/42', setIcon('amc.png'))
  addDir('Cool TV', 'https://digionline.hu/player/34', setIcon('cool-tv.png'))
  addDir('Paramount Channel', 'https://digionline.hu/player/35', setIcon('paramount-channel.png'))
  addDir('FEM', 'https://digionline.hu/player/206', setIcon('fem3.png'))
  addDir('Film +', 'https://digionline.hu/player/32', setIcon('film.png'))
  addDir('Mozi +', 'https://digionline.hu/player/214', setIcon('mozi.png'))
  addDir('PRIME', 'https://digionline.hu/player/225', setIcon('prime.png'))
  addDir('Comedy Central', 'https://digionline.hu/player/10', setIcon('comedy-central.png'))
  addDir('Humor +', 'https://digionline.hu/player/211', setIcon('humor.png'))
  addDir('Izaura TV', 'https://digionline.hu/player/212', setIcon('izaura.png'))
  addDir('Film Now', 'https://digionline.hu/player/232', setIcon('film-now.png'))

  addDir('RTL Klub', 'https://digionline.hu/player/37', setIcon('rtl-klub.png'))
  addDir('RTL Spike', 'https://digionline.hu/player/219', setIcon('rtl-spike.png'))
  addDir('RTL II', 'https://digionline.hu/player/29', setIcon('rtlii.png'))
  addDir('SuperTV2', 'https://digionline.hu/player/208', setIcon('supertv2.png'))
  addDir('TV2 HD', 'https://digionline.hu/player/204', setIcon('tv2-hd.png'))
  addDir('Duna HD', 'https://digionline.hu/player/43', setIcon('duna-hd.png'))
  addDir('Duna World', 'https://digionline.hu/player/44', setIcon('duna-world-hd.png'))
  addDir('M1 HD', 'https://digionline.hu/player/39', setIcon('m1-hd.png'))
  addDir('M2 HD', 'https://digionline.hu/player/42', setIcon('m2-hd.png'))
  addDir('M5 HD', 'https://digionline.hu/player/132', setIcon('m5-hd.png'))

  addDir('Spektrum', 'https://digionline.hu/player/130', setIcon('spektrum.png'))
  addDir('Digi Life', 'https://digionline.hu/player/12', setIcon('digi-life.png'))
  addDir('Digi World', 'https://digionline.hu/player/1', setIcon('digi-world.png'))
  addDir('TLC', 'https://digionline.hu/player/215', setIcon('tlc.png'))
  addDir('TV Paprika', 'https://digionline.hu/player/23', setIcon('tv-paprika.png'))
  addDir('Lichi TV', 'https://digionline.hu/player/227', setIcon('lichi-tv.png'))
  addDir('Discovery Channel ', 'https://digionline.hu/player/203', setIcon('discovery-channel.png'))
  addDir('Nat. Geographic', 'https://digionline.hu/player/220', setIcon('nat-geo-hd.png'))
  addDir('Nat. Geo. Wild', 'https://digionline.hu/player/222', setIcon('nat-geo-wild-hd.png'))
  addDir('Digi Animal World', 'https://digionline.hu/player/7', setIcon('digi-animal-world.png'))
  addDir('History Channel', 'https://digionline.hu/player/45', setIcon('history.png'))
  addDir('Viasat History', 'https://digionline.hu/player/4', setIcon('viasat-history.png'))
  addDir('Viasat Nature', 'https://digionline.hu/player/21', setIcon('viasat-nature.png'))

  ## Kidz
  addDir('Nickelodeon', 'https://digionline.hu/player/207', setIcon('nickelodeon.png'))
  addDir('Minimax', 'https://digionline.hu/player/226', setIcon('minimax-c8.png'))
  addDir('Kiwi TV', 'https://digionline.hu/player/213', setIcon('kiwi-tv.png'))

  ## Music
  addDir('Hit Music Channel', 'https://digionline.hu/player/2', setIcon('h-t-music-channel.png'))
  addDir('Music Channel', 'https://digionline.hu/player/5', setIcon('music-channel.png'))
  addDir('MTV Hungary', 'https://digionline.hu/player/228', setIcon('mtv-europe.png'))
  addDir('Zenebutik', 'https://digionline.hu/player/216', setIcon('zenebutik.png'))

  ## Sport
  addDir('M4 Sport', 'https://digionline.hu/player/41', setIcon('m4-sport-hd.png'))
  addDir('Digi Sport 1', 'https://digionline.hu/player/26', setIcon('digi-sport-1-hd.png'))
  addDir('Digi Sport 2', 'https://digionline.hu/player/27', setIcon('digi-sport-2-hd.png'))
  addDir('Digi Sport 3', 'https://digionline.hu/player/131', setIcon('digi-sport-3-hd.png'))
  addDir('Eurosport 1', 'https://digionline.hu/player/205', setIcon('eurosport-hd.png'))
  addDir('Eurosport 2', 'https://digionline.hu/player/210', setIcon('eurosport-2-hd.png'))
  addDir('SPORT1', 'https://digionline.hu/player/126', setIcon('sport1.png'))
  addDir('SPORT2', 'https://digionline.hu/player/118', setIcon('sport2.png'))
  #addDir('TEST', 'https://digionline.hu/player/13', setIcon('movies.png'))
